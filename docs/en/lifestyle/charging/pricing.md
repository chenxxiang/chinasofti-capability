...
<tbody>
<tr>
<td style="padding:14px 20px;background:#ffffff;color:#111827;border:1px solid #d1d5db;">Charging Platform</td>
<td style="padding:14px 20px;background:#ffffff;color:#111827;border:1px solid #d1d5db;">Standard Edition</td>
<td style="padding:14px 20px;background:#ffffff;color:#111827;border:1px solid #d1d5db;text-align:right;font-weight:700;">350,000</td>
</tr>
</tbody>
</table>
</div>

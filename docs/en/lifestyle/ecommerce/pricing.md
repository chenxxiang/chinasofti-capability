...
<tbody>
<tr>
<td style="padding:14px 20px;background:#ffffff;color:#111827;border:1px solid #d1d5db;">E-Commerce Platform</td>
<td style="padding:14px 20px;background:#ffffff;color:#111827;border:1px solid #d1d5db;">Standard Edition, unlimited users</td>

...
<tbody>
<tr>
<td style="padding:14px 20px;background:#ffffff;color:#111827;border:1px solid #d1d5db;">Ticketing System</td>
<td style="padding:14px 20px;background:#ffffff;color:#111827;border:1px solid #d1d5db;">Admin portal, merchant portal, customer app, validator app, USSD, dashboard</td>
<td style="padding:14px 20px;background:#ffffff;color:#111827;border:1px solid #d1d5db;text-align:right;font-weight:700;">262,000</td>
</tr>
</tbody>
</table>
</div>

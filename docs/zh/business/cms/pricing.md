...
<tbody>
<tr>
<td style="padding:14px 20px;background:#ffffff;color:#111827;border:1px solid #d1d5db;">内容分发平台</td>
<td style="padding:14px 20px;background:#ffffff;color:#111827;border:1px solid #d1d5db;">标准版</td>
<td style="padding:14px 20px;background:#ffffff;color:#111827;border:1px solid #d1d5db;text-align:right;font-weight:700;">450,000</td>
</tr>
</tbody>
</table>
</div>

  ...
  '/en/': [
    {
      ...
      items: [
        {
          text: 'Content Management System', collapsed: true,
          items: [
        ...
        {
          text: 'IoT Platform', collapsed: true,
          items: [
    ...
    },
    {
      ...
      items: [
        {
          text: 'Charging Platform', collapsed: true,
          items: [
        ...
        {
          text: 'Transit Card', collapsed: true,
          items: [
        ...
        {
          text: 'E-Commerce Platform', collapsed: true,
          items: [
        ...
        {
          text: 'Catering Platform', collapsed: true,
          items: [
        ...
        {
          text: 'Ticketing System', collapsed: true,
          items: [
    ...
    },
    {
      ...
      items: [
        {
          text: 'Blockchain Integration', collapsed: true,
          items: [
        ...
        {
          text: 'Wealth Management', collapsed: true,
          items: [
    ...
    },
    {
      ...
      items: [
        {
          text: 'IM Platform', collapsed: true,
          items: [
        ...
        {
          text: 'Game Management Platform', collapsed: true,
          items: [
